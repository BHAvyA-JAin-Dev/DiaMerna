...
(function () {
  ...
  /* Full screen chat — only on chat.html */
  ...
  /* FAB popup (present on every page) */
  ...
  if (fab && panel) {
    fab.addEventListener('click', () => {
      ...
      if (panel.classList.contains('open') && fabInp) fabInp.focus()
    })
    if (fabClose) {
